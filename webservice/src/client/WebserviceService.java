 ...
 * 
 */
@WebServiceClient(name = "webserviceService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:9091/Service/webservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9091/Service/webservice?wsdl");
